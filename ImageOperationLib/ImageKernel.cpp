...
/// ѕолучение €дра √аусса
/// </summary>
/// <param name="size"> размер €дра</param>
/// <param name="sigma"> среднеквадратичное отклонение нормального распределени€</param>
/// <returns> €дро √аусса</returns>
...
/// <summary>
/// ядро Ћаплассиан-√ауссиана
/// </summary>
/// <param name="size">размер €дра (нечетное число)</param>
/// <param name="sigma">среднеквадратичное отклонение нормального распределени€</param>
/// <returns></returns>
